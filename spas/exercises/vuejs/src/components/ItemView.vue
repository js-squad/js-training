...
export default {
  ...
  route: {
    ...
    activate () {
      console.log('Router lifecycle: ItemView activated.')
    },

    deactivate () {
      console.log('Router lifecycle: ItemView deactivated.')
    }
  },

  created () {
    console.log('Component lifecycle: ItemView created.')
  },

  destroyed () {
    console.log('Component lifecycle: ItemView destroyed.')
  },
